...
public void inicializarComponentes() {
	...
	enemigo=new Enemigo(50,30,1,"malo",8,"abajo",100);
    manhunt= new Pigsi(-2500,-3500,1,"pigsi",0,"abajo",1000);
    isac=new Soldado(-300, -2500, 1, "isac", 0, "abajo", 500);
...
if(isac.getVidaActual()<=0)
	jugadorAnimado.setPuntos(500);
if(enemigo.getVidaActual()<=0)
	jugadorAnimado.setPuntos(100);
enseñar();
}
...
public boolean ganar() {
	if(manhunt.getVidaActual()<=0) {
		jugadorAnimado.setPuntos(1000);
		JOptionPane.showInputDialog("Felicidades Completaste el Juego");
